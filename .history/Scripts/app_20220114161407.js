	...
	async function Start()
	{
		...
		let checkBlackout = function(zipCode, team) {
			...
			if ( validZipCode(zipCode) ) {
				...
				messageTxt = "<p>For zip codes starting with: <b>" + zipCode + "</b></p><p>The <b>" + team + "</b> games are ";
				...
				result.innerHTML = "<p>There are no valid zip codes starting with '<b>" + zipCode + "</b>'. Please check the first 3 characters of the zip code, and try again.</p>";
			}
